...
class PlayerActivity : AppCompatActivity() {
    ...
    companion object{
        ...
        lateinit var playerList1: ArrayList<Audio>
    ...
    private fun initializeLayout(){
        ...
        when(intent.getStringExtra("class")){
            ...
            "AllAudios" -> {
                playerList1 = ArrayList()
                playerList1.addAll(MainActivity.audioList)
                createAudioPlayer()
            }
    ...
    private fun createAudioPlayer(){
        ...
        val mediaItem = MediaItem.fromUri(playerList1[position].artUri)
